...
const glassButtonVariants = cva(
  "relative isolate all-unset cursor-pointer rounded-full transition-all",
  {
    variants: {
      size: {
        default: "font-sans text-base font-semibold tracking-tight",
        sm: "font-sans text-sm font-semibold tracking-tight",
        lg: "font-sans text-lg font-semibold tracking-tight",
        icon: "h-10 w-10",
      },
    },
    defaultVariants: {
